...
export const SingleDocumentChat = ({ caseDetails, closePopup,documentDetails }) => {
    ...
    //#region print section code here 
    const handlePrint = () => {
    ...
    return (
        <div className="chat-popup">
            <div className="chat-header flex justify-between items-center">
                <span> Chat with {documentDetails.document_name} </span>
                ...
                <div className="chat-content">
                    ...
                    <div className="mb-4 flex-1 space-y-4 overflow-y-auto">
                        {messages.map((message, index) => (
                            ...
                            >
                                <div
                                    className={`max-w-xs rounded-lg px-4 py-2 ${message.isUser
